...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("KNN: K=5 Tocnost: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_KNN))))
plt.tight_layout()
plt.show()
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("KNN: K=1 Tocnost: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_KNN))))
plt.tight_layout()
plt.show()
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("KNN: K=100 Tocnost: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_KNN))))
plt.tight_layout()
plt.show()
KNN_model = KNeighborsClassifier()
param_grid = {'n_neighbors': range(1, 20)}
KNN_model = GridSearchCV (KNN_model, param_grid, cv =5 , scoring ='accuracy', n_jobs = -1)
...
SVM_model = svm . SVC ( kernel ='rbf', gamma = 1.84 , C=4 )
...
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("SVM: Tocnost: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_SVM))))
plt.tight_layout()
plt.show()

SVM_model = svm . SVC()
param_grid = {'C': range(1, 20), 'gamma': [10 , 1 , 0.1 , 0.01 ]}
