...
#Crtanje train i test sa razlicitim bojama (cmap)
...
#Pravljenje modela i treniranje i prediktanje a testu
...
# Uzimanje koeficijenata theta i crtanje granice odluke (linearne)
